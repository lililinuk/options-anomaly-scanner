...
const caveats = [
  "Phase 2A v1.1 不使用 contract Volume/OI、Premium 或 Intraday Burst 評分。",
...
export default function FieldGuide() {
  return <div className="app-shell"><Sidebar active="/field-guide" /><main>
    ...
    <footer><p>Phase 2A v1.1 · Positioning research only</p><p>規格版本 signal_spec_v1.1_phase2a</p></footer>
  </main></div>;
}
