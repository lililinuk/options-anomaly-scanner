...
const caveats = [
  "Phase 2A v1.2 不使用 contract Volume/OI、Premium 或 Intraday Burst 評分。",
...
export default function FieldGuide() {
  return <div className="app-shell"><Sidebar active="/field-guide" /><main>
    ...
    <footer><p>Phase 2A v1.2 · Positioning research only</p><p>規格版本 signal_spec_v1.2_phase2a</p></footer>
  </main></div>;
}
